...
typedef const D2ItemStatCostTxt* LPItemStatCostTxt;
...
typedef const D2MagicAffixTxt* LPD2MagicAffixTxt;
...
typedef const D2MagicAffixDataTbl* LPD2MagicAffixDataTbl;
