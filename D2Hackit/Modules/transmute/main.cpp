...
VOID EXPORT OnGameJoin(THISGAMESTRUCT* thisgame)
{
	...
	rerollingOrb.push_back("lc_mm");
	rerollingOrb.push_back("lc_mr");
	rerollingOrb.push_back("lc_rr");
	rerollingOrb.push_back("gc_mm");
	rerollingOrb.push_back("gc_mr");
	rerollingOrb.push_back("gc_rr");
	rerollingOrb.push_back("devil");
