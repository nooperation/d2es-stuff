...
{
	server->GameCommandLine("rd start r21 r20 r19 r18 r17 r16");
	return TRUE;
}
...
MODULECOMMANDSTRUCT ModuleCommands[]=
{
	...
	},
	{
		"start",
		Start,
		"Downgrades all runes of type Arg1 Arg2 ... ArgN once. eg: .start r21 r20 r19 r18 r17 r16 to convert runes 21-16 to sa runes"
	},
	{
		"start_sa",
		StartSA,
