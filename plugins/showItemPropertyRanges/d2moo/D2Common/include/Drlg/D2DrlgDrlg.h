...
struct D2ActiveRoomStrc // Used to be called D2RoomStrc
{
	...
	uint32_t nLastDeadGUIDs[4];			//0x68
...
struct D2DrlgStrc
{
	...
	void* pMempool;							//0x04
	void* hArchive;					//0x08 Always nullptr in the game, used by DRLGPRESET_LoadDrlgFile to load DS1 binary data
...
struct D2DrlgActStrc
{
	...
	int32_t bClient;							//0x1C
	int32_t unk0x20;							//0x20
	int32_t bUpdateEx;							//0x24
	int32_t bUpdate;							//0x28
